...
<div class="row">
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
        ...
        <div class="card ">
            ...
            @include('users._replies', ['replies' => $user->replies()->orderBy('updated_at','desc')->with('topic')->paginate()])
            @else
            @include('users._topics', ['topics' => $user->topics()->orderBy('updated_at','desc')->paginate()])
            @endif
            </div>
        </div>
